...
import com.bjsxt.ejb.Category;
import com.bjsxt.ejb.Msg;
import com.bjsxt.ejb.MsgInfo;
import com.bjsxt.ejb.Topic;
...
//		q.setParameter(1, 8);
	...
	public void testHQL_12() {
		Session session = sf.openSession();
		session.beginTransaction();
		Query q = session.createQuery("select new com.bjsxt.ejb.MsgInfo(m.id, m.cont, m.topic.title, m.topic.category.name) from Msg");
